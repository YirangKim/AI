...
df_crawling2024 = pd.DataFrame(rows, columns=['판례일련번호', '사건명', '사건번호', '선고일자', '법원명', '사건종류명', '사건종류코드', '판결유형', '선고', '판시사항', '판결요지', '참조조문', '참조판례', '판례내용'])

# 필터링된 데이터를 CSV 파일로 저장
df_crawling2024.to_csv('crawling2024.csv', index=False, encoding='utf-8-sig')
print("Data collection complete. Saved to crawling2024.csv")

# 데이터프레임 출력
print(df_crawling2024.head())